...
The final step is reporting to the user. After Step 3, each analyser reports its findings back to the user. It goes without saying that the analyser should give clear and precise information of what happened.
